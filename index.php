...
<div class="container">
    ...
    <nav>
        <a href="../index.php" class="btn btn-edit">Accueil</a>
        <a href="../auteurs/index.php" class="btn btn-edit">Auteurs</a>
        <a href="../categories/index.php" class="btn btn-edit">Catégories</a>
        <a href="index.php" class="btn btn-add">Livres</a>
    </nav>
    ...
    <form method="POST" action="index.php">
        ...
        <label>Titre :</label>
        <input type="text" name="titre" value="<?= $edit ? $livre->titre : '' ?>" required>
        <label>ISBN :</label>
        <input type="text" name="isbn" value="<?= $edit ? $livre->isbn : '' ?>" required>
        <label>Année :</label>
        <input type="number" name="annee" value="<?= $edit ? $livre->annee : '' ?>" required>
        <label>Quantité :</label>
        <input type="number" name="quantite" value="<?= $edit ? $livre->quantite : '' ?>" required>
        
        <label>Auteur :</label>
        <select name="auteur_id" required>
            <option value="">-- Choisir --</option>
            <?php
            $stmt_a = $auteur->lireTous();
    ...
    <table>
        ...
        while($row = $stmt->fetch()) {
            echo "<tr>
                    ...
                    <td>{$row['categorie_libelle']}</td>
                    <td>
                        <a href='index.php?edit={$row['id']}' class='btn btn-edit'>Modifier</a>
                        <a href='index.php?delete={$row['id']}' class='btn btn-delete' onclick='return confirm(\"Supprimer ?\")'>Supprimer</a>
                    </td>
                  </tr>";
        }
        ?>
